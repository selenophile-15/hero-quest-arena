...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      // portal-root가 transform 컨텍스트 안에 있으므로 fixed 대신 absolute 사용
      // 데스크탑 모드에서는 portal-root가 inset-0 absolute로 설정되어 있음
...
>(({ className, children, hideCloseButton, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // fixed → absolute: portal-root(transform 컨텍스트) 기준 중앙 배치
