        ...
        <div className="w-full px-6 flex gap-1 items-center">
          {TABS.map((tab) => {
            ...
            return (
              ...
              >
                <Icon
                  className={`w-4 h-4 transition-transform duration-300 ${isActive ? "scale-110" : "group-hover:scale-105 group-hover:-translate-y-[1px]"}`}
                />
                <span
                  className={`transition-transform duration-300 ${isActive ? "" : "group-hover:-translate-y-[1px]"}`}
                >
                  {tab.label}
                </span>
                <span
